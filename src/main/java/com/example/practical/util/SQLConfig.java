...
public class SQLConfig {
    ...
    public static final String DATABASE_ACCOUNT_INSERT = "insert into users ( username, password ) values (?,?)";
    public static final String SELECT_ACCOUNT_BY_USERNAME = "select * from users where username = ?";
}
